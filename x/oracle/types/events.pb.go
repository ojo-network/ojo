...
// EventSetFxRateVote is emitted on exchange rate vote update
type EventSetFxRateVote struct {
	// uToken denom
	Denom string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	// Exchange rate (based to USD)
	Rate cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=rate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"rate"`
...
func (m *EventSetFxRateVote) Reset()         { *m = EventSetFxRateVote{} }
func (m *EventSetFxRateVote) String() string { return proto.CompactTextString(m) }
func (*EventSetFxRateVote) ProtoMessage()    {}
func (*EventSetFxRateVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b8914220a86f2fd, []int{2}
}
func (m *EventSetFxRateVote) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventSetFxRateVote) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventSetFxRateVote.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventSetFxRateVote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventSetFxRateVote.Merge(m, src)
}
func (m *EventSetFxRateVote) XXX_Size() int {
	return m.Size()
}
func (m *EventSetFxRateVote) XXX_DiscardUnknown() {
	xxx_messageInfo_EventSetFxRateVote.DiscardUnknown(m)
}

var xxx_messageInfo_EventSetFxRateVote proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*EventSetFxRateVote)(nil), "ojo.oracle.v1.EventSetFxRateVote")
}
...
var fileDescriptor_6b8914220a86f2fd = []byte{
	...
	,
}
...
func (m *EventSetFxRateVote) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventSetFxRateVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventSetFxRateVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventSetFxRateVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventSetFxRateVote) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventSetFxRateVote: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventSetFxRateVote: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
