...
type CurrencyPairProviders struct {
	...
	Providers  []string `protobuf:"bytes,3,rep,name=providers,proto3" json:"providers,omitempty" yaml:"providers"`
}
...
var fileDescriptor_e2b9fb194216b28f = []byte{
	...
	,
}
