...
type Params struct {
	...
	// Price Feeder Currency Pair Providers defines the currency provider
	// pairs the price feeder uses upon start up for pricing data.
	PriceFeederCurrencyPairProviders CurrencyPairProvidersList `protobuf:"bytes,14,rep,name=price_feeder_currency_pair_providers,json=priceFeederCurrencyPairProviders,proto3,castrepeated=CurrencyPairProvidersList" json:"price_feeder_currency_pair_providers" yaml:"price_feeder_currency_pair_providers"`
	...
	PriceFeederCurrencyDeviationThresholds CurrencyDeviationThresholdList `protobuf:"bytes,15,rep,name=price_feeder_currency_deviation_thresholds,json=priceFeederCurrencyDeviationThresholds,proto3,castrepeated=CurrencyDeviationThresholdList" json:"price_feeder_currency_deviation_thresholds" yaml:"price_feeder_currency_deviation_thresholds"`
}
...
type CurrencyPairProviders struct {
	...
	AddressProvider string   `protobuf:"bytes,4,opt,name=address_provider,json=addressProvider,proto3" json:"address_provider,omitempty" yaml:"address_provider"`
	Providers       []string `protobuf:"bytes,5,rep,name=providers,proto3" json:"providers,omitempty" yaml:"providers"`
}
...
var fileDescriptor_e2b9fb194216b28f = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if len(this.PriceFeederCurrencyPairProviders) != len(that1.PriceFeederCurrencyPairProviders) {
		return false
	}
	for i := range this.PriceFeederCurrencyPairProviders {
		if !this.PriceFeederCurrencyPairProviders[i].Equal(&that1.PriceFeederCurrencyPairProviders[i]) {
			return false
		}
	}
	if len(this.PriceFeederCurrencyDeviationThresholds) != len(that1.PriceFeederCurrencyDeviationThresholds) {
		return false
	}
	for i := range this.PriceFeederCurrencyDeviationThresholds {
		if !this.PriceFeederCurrencyDeviationThresholds[i].Equal(&that1.PriceFeederCurrencyDeviationThresholds[i]) {
			return false
		}
	}
	return true
