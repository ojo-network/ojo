...
Thank you for considering making contributions to the Ojo network! 🌟
...
1. If you would like to contribute, first do your best to check if discussions
   already exist as either a Github [Discussion](https://github.com/ojo-network/ojo/discussions),
   [Issue](https://github.com/ojo-network/ojo/issues) or
   [PR](https://github.com/ojo-network/ojo/pulls). Be sure to also check out
   our public [Discord](https://discord.com/invite/wS8MKvxb3M). Existing discussions will help you
   gain context on the current status of the proposed contribution or topic. If
   one does not exist, feel free to start one.
2. If you would like to create a [Github Issue](https://github.com/ojo-network/ojo/issues),
   either [open](https://github.com/ojo-network/ojo/issues/new/choose) or
   [find](https://github.com/ojo-network/ojo/issues) an issue you'd like to
...
When proposing a design decision for the Ojo network, please start by
opening an [Issue](https://github.com/ojo-network/ojo/issues/new/choose) or a
[Discussion](https://github.com/ojo-network/ojo/discussions/new) with a summary
of the proposal.

Once the proposal has been discussed and there is rough alignment on a high-level
approach to the design, a [design doc](https://github.com/ojo-network/ojo/blob/main/docs/design/README.md) can be drafted in a dedicated pull request.
...
The Ojo network repo adheres to the [trunk based development branching](https://trunkbaseddevelopment.com/)
